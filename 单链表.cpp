...
} linked_list;/*书上的代码：node,*linklist;（其中Linklist为结构指针类型）*/
...
linked_list *init() {
  ...
  linked_list *head = (linked_list *)malloc(sizeof(linked_list));//建立头结点,head为指向单链表头结点的指针

  (head)->next = NULL;//建立空的单链表 head
